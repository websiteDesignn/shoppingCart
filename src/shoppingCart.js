...
const shoppingCartItemsWrapper = document.querySelector(
  "[data-shoppingCart-items-wrapper]"
);
let shoppingCart = [];
const imageUrl =
  "https://github.com/websiteDesignn/shoppingCart/blob/main/src/img";
const shoppingCartItemTemplate = document.querySelector(
  "#shoppingCart-item-template"
);
const shoppingCartItemContainer = document.querySelector(
  "[data-shoppingCart-item-container]"
);
const shoppingCartQuantity = document.querySelector(
  "[data-shoppingCart-quantity]"
);
...
export function setupShoppingCart() {
  addGlobalEventListener(
    "click",
    "[data-remove-from-shoppingCart-button]",
    (e) => {
